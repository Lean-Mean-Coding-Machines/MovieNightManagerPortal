      ...
      >
        <Box sx={modalStyle}>
          ...
          <Box sx={{ marginTop: '20px' }}>
                  ...
                  <span style={{ display: 'flex' }}>
                    ...
                    <li>
                      <span style={{ marginLeft: '-8px' }}>
                        {`${Math.floor(props.nomination.runtime / 60)}h ${
                          props.nomination.runtime % 60
                        }m`}
                      </span>
                    </li>
                  </span>
            ...
            {props.nomination.genres.length > 0 &&
              props.nomination.genres[0] !== '' && (
            ...
            {!desktopView && (
              <div>
                {props.nomination.movieOverview?.length > 350 &&
                  !expandText && (
                    <Button
                      sx={{ border: '1px solid' }}
